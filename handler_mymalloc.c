/*
This file is using the signal handler strategy.
It is not the assignment, just for reference of what I have mentioned in the report.
The assignment implementation is in the file mymalloc.c
*/
...
static void st_handler(int sig)
{
  errno = EINVAL;
